  ...
  Widget build(BuildContext context) => DefaultTabController(
      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            title: Visibility(
                visible: show_title, child: const Text("WhatsApp Clone")),
            actions: [
              Visibility(
              ...
              Visibility(
                ...
                child: Consumer<Screen>(builder: (context, value, child) {
                  print("Widget reloading");
                  if (value.getScreenVal() == 0) {
                    return PopupMenuButton(
                        icon: Icon(Icons.more_vert),
                        itemBuilder: (context) => [
                              PopupMenuItem(child: Text("Settings")),
                            ]);
                  } else if (value.getScreenVal() == 1) {
                    return PopupMenuButton(
                        icon: Icon(Icons.more_vert),
                        itemBuilder: (context) => [
